# Generated by Django 4.2.7 on 2023-12-17 22:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('checking', models.BooleanField(blank=True, default=False, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auction', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='auctions.auctioning')),
            ],
        ),
        migrations.CreateModel(
            name='Bid',
        ...
        migrations.AddField(
            model_name='auctioning',
            name='price',
            field=models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='price', to='auctions.bid'),
        ),
        migrations.AddField(
            model_name='auctioning',
            name='watchlist',
